...
class Mysql2::Client
  ...
  # source://mysql2//lib/mysql2.rb#36
  ...
  # path is provide.
  #
  # source://mysql2//lib/mysql2/client.rb#123
  def find_default_ca_path; end

  # source://mysql2//lib/mysql2/client.rb#159
  def info; end
  ...
  #
  # source://mysql2//lib/mysql2/client.rb#134
  def parse_connect_attrs(conn_attrs); end

  # source://mysql2//lib/mysql2/client.rb#106
  def parse_flags_array(flags, initial = T.unsafe(nil)); end

  # source://mysql2//lib/mysql2/client.rb#95
  ...
  # source://mysql2//lib/mysql2/client.rb#144
  ...
  # source://mysql2//lib/mysql2/client.rb#165
  ...
  class << self
    ...
    # source://mysql2//lib/mysql2/client.rb#181
...
class Mysql2::Error < ::StandardError
  ...
  #
  # source://mysql2//lib/mysql2/error.rb#50
  def errno; end

  # source://mysql2//lib/mysql2/error.rb#51
  def error; end
