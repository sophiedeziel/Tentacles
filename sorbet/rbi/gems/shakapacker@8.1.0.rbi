...
module Shakapacker::Helper
  # source://shakapacker//lib/shakapacker/helper.rb#182
  ...
  #
  # source://shakapacker//lib/shakapacker/helper.rb#125
  def preload_pack_asset(name, **options); end

  # source://shakapacker//lib/shakapacker/helper.rb#188
  def prepend_javascript_pack_tag(*names, defer: T.unsafe(nil)); end
  ...
  #
  # source://shakapacker//lib/shakapacker/helper.rb#158
  ...
  # source://shakapacker//lib/shakapacker/helper.rb#208
  def javascript_pack_tag_queue; end

  # source://shakapacker//lib/shakapacker/helper.rb#223
  def resolve_path_to_image(name, **options); end

  # source://shakapacker//lib/shakapacker/helper.rb#215
  def sources_from_manifest_entrypoints(names, type:); end

  # @yield [defer ? :deferred : :non_deferred]
  #
  # source://shakapacker//lib/shakapacker/helper.rb#196
  def update_javascript_pack_tag_queue(defer:); end
end
