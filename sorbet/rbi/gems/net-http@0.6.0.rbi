...
class Net::HTTP < ::Net::Protocol
  ...
  #
  # source://net-http//net/http.rb#1148
  ...
  # @return [Boolean]
  #
  # source://net-http//net/http.rb#1484
  def active?; end

  # Returns the string host name or host IP given as argument +address+ in ::new.
  #
  # source://net-http//net/http.rb#1264
  def address; end

  # Sets or returns the path to a CA certification file in PEM format.
  #
  # source://net-http//net/http.rb#1535
  def ca_file; end
  ...
  #
  # source://net-http//net/http.rb#1539
  def ca_path; end
  ...
  #
  # source://net-http//net/http.rb#1543
  def cert; end
  ...
  #
  # source://net-http//net/http.rb#1546
  def cert_store; end
  ...
  #
  # source://net-http//net/http.rb#1550
  def ciphers; end
  ...
  # initially +false+.
  #
  # source://net-http//net/http.rb#1492
  ...
  #
  # source://net-http//net/http.rb#1445
  ...
  #
  # source://net-http//net/http.rb#1451
  ...
  #   http.copy('/todos/1')
  #
  # source://net-http//net/http.rb#2195
  ...
  #   http.delete('/todos/1')
  #
  # source://net-http//net/http.rb#2169
  ...
  #
  # source://net-http//net/http.rb#1554
  ...
  #
  # source://net-http//net/http.rb#1981
  ...
  #
  # source://net-http//net/http.rb#2248
  ...
  #    ["connection", ["close"]]]
  #
  # source://net-http//net/http.rb#2005
  ...
  #
  # source://net-http//net/http.rb#2261
  ...
  # initially +true+.
  #
  # source://net-http//net/http.rb#1468
  def ignore_eof; end
  ...
  #   http.finish
  #
  # source://net-http//net/http.rb#1345
  def ipaddr; end
  ...
  # @raise [IOError]
  #
  # source://net-http//net/http.rb#1357
  def ipaddr=(addr); end
  ...
  #
  # source://net-http//net/http.rb#1463
  ...
  #
  # source://net-http//net/http.rb#1557
  def key; end
  ...
  # initially +nil+.
  #
  # source://net-http//net/http.rb#1271
  def local_host; end
  ...
  # initially +nil+.
  #
  # source://net-http//net/http.rb#1275
  def local_port; end
  ...
  #
  # source://net-http//net/http.rb#2115
  def lock(path, body, initheader = T.unsafe(nil)); end

  # Returns the maximum number of times to retry an idempotent request;
  # see #max_retries=.
  #
  # source://net-http//net/http.rb#1401
  def max_retries; end
  ...
  #
  # source://net-http//net/http.rb#1568
  def min_version; end
  ...
  #   http = Net::HTTP.new(hostname)
  #
  # source://net-http//net/http.rb#2209
  ...
  #   http.move('/todos/1')
  #
  # source://net-http//net/http.rb#2182
  ...
  #   http.options('/')
  #
  # source://net-http//net/http.rb#2142
  ...
  #
  # source://net-http//net/http.rb#2068
  ...
  # or +nil+ if none.
  #
  # source://net-http//net/http.rb#1593
  def peer_cert; end

  # Returns the integer port number given as argument +port+ in ::new.
  #
  # source://net-http//net/http.rb#1267
  def port; end
  ...
  #
  # source://net-http//net/http.rb#2039
  ...
  #   "{\n  \"xyzzy\": \"\",\n  \"id\": 201\n}"
  #
  # source://net-http//net/http.rb#2288
  ...
  #
  # source://net-http//net/http.rb#2156
  ...
  #
  # source://net-http//net/http.rb#2101
  ...
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1874
  def proxy_address; end

  # Sets the proxy address;
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1311
  ...
  #
  # source://net-http//net/http.rb#1307
  ...
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1905
  def proxy_pass; end

  # Sets the proxy password;
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1323
  def proxy_pass=(_arg0); end

  # Returns the port number of the proxy server, if defined, +nil+ otherwise;
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1884
  def proxy_port; end

  # Sets the proxy port;
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1315
  def proxy_port=(_arg0); end

  # The proxy URI determined from the environment for this connection.
  #
  # source://net-http//net/http.rb#1864
  def proxy_uri; end
  ...
  #
  # source://net-http//net/http.rb#1324
  def proxy_use_ssl=(_arg0); end

  # Returns the user name of the proxy server, if defined, +nil+ otherwise;
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1894
  def proxy_user; end

  # Sets the proxy user;
  # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
  #
  # source://net-http//net/http.rb#1319
  ...
  #
  # source://net-http//net/http.rb#2087
  ...
  #
  # source://net-http//net/http.rb#2302
  ...
  # see #read_timeout=.
  #
  # source://net-http//net/http.rb#1372
  ...
  #
  # source://net-http//net/http.rb#1414
  ...
  #   #<Net::HTTPOK 200 OK readbody=false>
  #
  # source://net-http//net/http.rb#2367
  ...
  #
  # source://net-http//net/http.rb#1279
  ...
  #
  # source://net-http//net/http.rb#1299
  ...
  #   # => #<Net::HTTPCreated 201 Created readbody=true>
  #
  # source://net-http//net/http.rb#2331
  ...
  #   Conn keep-alive
  #
  # source://net-http//net/http.rb#1258
  def set_debug_output(output); end

  # Sets or returns the SSL timeout seconds.
  #
  # source://net-http//net/http.rb#1560
  def ssl_timeout; end
  ...
  #
  # source://net-http//net/http.rb#1564
  def ssl_version; end
  ...
  # @raise [IOError]
  #
  # source://net-http//net/http.rb#1621
  def start; end
  ...
  #   http.trace('/todos/1')
  #
  # source://net-http//net/http.rb#2222
  ...
  #
  # source://net-http//net/http.rb#2129
  ...
  #
  # source://net-http//net/http.rb#1506
  ...
  # @return [Boolean]
  #
  # source://net-http//net/http.rb#1496
  def use_ssl?; end

  # Sets or returns the callback for the server certification verification.
  #
  # source://net-http//net/http.rb#1575
  ...
  #
  # source://net-http//net/http.rb#1578
  ...
  #
  # source://net-http//net/http.rb#1588
  ...
  #
  # source://net-http//net/http.rb#1583
  def verify_mode; end
  ...
  # see #write_timeout=.
  #
  # source://net-http//net/http.rb#1377
  ...
  #
  # source://net-http//net/http.rb#2547
  def D(msg); end

  # source://net-http//net/http.rb#2539
  def addr_port; end

  # source://net-http//net/http.rb#2456
  def begin_transport(req); end

  # without proxy, obsolete
  #
  # source://net-http//net/http.rb#1926
  def conn_address; end

  # source://net-http//net/http.rb#1930
  def conn_port; end

  # source://net-http//net/http.rb#1641
  def connect; end
  ...
  # source://net-http//net/http.rb#1775
  def do_finish; end

  # source://net-http//net/http.rb#1635
  def do_start; end

  # source://net-http//net/http.rb#1934
  def edit_path(path); end

  # source://net-http//net/http.rb#2479
  def end_transport(req, res); end

  # @return [Boolean]
  #
  # source://net-http//net/http.rb#2496
  def keep_alive?(req, res); end

  # source://net-http//net/http.rb#1757
  def on_connect; end

  # Executes a request which uses a representation
  # and returns its body.
  #
  # source://net-http//net/http.rb#2390
  def send_entity(path, data, initheader, dest, type, &block); end

  # source://net-http//net/http.rb#2520
  def sspi_auth(req); end

  # @return [Boolean]
  #
  # source://net-http//net/http.rb#2505
  def sspi_auth?(res); end

  # source://net-http//net/http.rb#2401
  def transport_request(req); end

  # source://net-http//net/http.rb#1919
  ...
  class << self
    ...
    #
    # source://net-http//net/http.rb#1802
    ...
    #
    # source://net-http//net/http.rb#1142
    ...
    #
    # source://net-http//net/http.rb#935
    ...
    #
    # source://net-http//net/http.rb#804
    ...
    # returns +nil+.
    #
    # source://net-http//net/http.rb#763
    ...
    #
    # source://net-http//net/http.rb#814
    ...
    #
    # source://net-http//net/http.rb#943
    ...
    #
    # source://net-http//net/http.rb#951
    ...
    # @return [Boolean]
    #
    # source://net-http//net/http.rb#748
    ...
    # @return [Boolean]
    #
    # source://net-http//net/http.rb#743
    ...
    # see {Proxy Server}[rdoc-ref:Net::HTTP@Proxy+Server].
    #
    # source://net-http//net/http.rb#1100
    ...
    #
    # source://net-http//net/http.rb#857
    ...
    #   }
    #
    # source://net-http//net/http.rb#884
    def post_form(url, params); end

    # Returns the address of the proxy host, or +nil+ if none;
    # see Net::HTTP@Proxy+Server.
    #
    # source://net-http//net/http.rb#1832
    def proxy_address; end
    ...
    # @return [Boolean]
    #
    # source://net-http//net/http.rb#1826
    def proxy_class?; end

    # Returns the password for accessing the proxy, or +nil+ if none;
    # see Net::HTTP@Proxy+Server.
    #
    # source://net-http//net/http.rb#1844
    def proxy_pass; end

    # Returns the port number of the proxy host, or +nil+ if none;
    # see Net::HTTP@Proxy+Server.
    #
    # source://net-http//net/http.rb#1836
    def proxy_port; end

    # Use SSL when talking to the proxy. If Net::HTTP does not use a proxy, nil.
    #
    # source://net-http//net/http.rb#1847
    def proxy_use_ssl; end

    # Returns the user name for accessing the proxy, or +nil+ if none;
    # see Net::HTTP@Proxy+Server.
    #
    # source://net-http//net/http.rb#1840
    def proxy_user; end
    ...
    # source://net-http//net/http.rb#955
    def socket_type; end
    ...
    #
    # source://net-http//net/http.rb#1045
    ...
    # Returns +true+; retained for compatibility.
    #
    # source://net-http//net/http.rb#738
    def version_1_2; end
...
# :stopdoc:
#
# source://net-http//net/http.rb#727
...
#
# source://net-http//net/http.rb#2559
